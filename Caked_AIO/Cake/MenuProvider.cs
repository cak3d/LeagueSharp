...
namespace Caked_AIO
{
    ...
    class MenuProvider
    {
        ...
        internal static void initialize()
        {
            ...
            {
                MenuInstance = new Menu("Caked#: OK", "SharpShooterCommon", true);
            ...
            {
                MenuInstance = new Menu("Caked#: X", "SharpShooterCommon", true);

                addItem("txt1", "Sorry. " + ObjectManager.Player.ChampionName + " is not supported yet.", null);
                Game.PrintChat("<font color = \"#00D8FF\"><b>Caked#:</b></font> <font color = \"#FF007F\">" + ObjectManager.Player.ChampionName + "</font> is not supported yet.");
            }

            MenuInstance.AddToMainMenu();

            Console.WriteLine("Caked#: MenuProvider Initialized.");
        }
        ...
        internal class Champion
        {
            ...
            internal class Drawings
            {
                ...
                internal static void addDamageIndicator(DamageIndicator.DamageToUnitDelegate damage)
                {
                    ...
                    var drawDamageFill = new MenuItem("DamageIndicator_FillColor", "DamageIndicator FillColor", true).SetValue(new Circle(true, System.Drawing.Color.Goldenrod));
                ...
                {
                    var drawDamageMenu = new MenuItem("Draw_DamageIndicatorForJungle", "DamageIndicator For Jungle", true).SetValue(true);
                    var drawDamageFill = new MenuItem("DamageIndicatorForJungle_FillColor", "DamageIndicator For Jungle FillColor", true).SetValue(new Circle(true, System.Drawing.Color.GreenYellow));
